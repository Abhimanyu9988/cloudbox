		  ...
		  for($i=0; $i < $count; $i++){
			for($j=0; $j< count($mobile); $j++){
			  ...
			  if((mysqli_num_rows($result)>0)){
				...
				mysqli_query($conn,"INSERT INTO utest(file,mobile,user_id) values ('$var','$var1','$u_id')");
			  }          
			}
		  }
		  for($j=0; $j< count($mobile); $j++){
	...
	<div class="banner">
			  ...
			  <img src="images/b.jpeg" alt="banner" style="display: block; max-width: 100%; height: 730px;"> <!-- size is 1600x750 -->
			  ...
			  <div class="caption">
				<div class="caption-wrapper">
				  ...
				  <a href="logout.php" style="position: absolute;right: 10px;top: 10px; padding:20px;" class="btn btn-default">Logout</a>
					<?php
					echo "<img id='proPic' src='".$pic."' class='img-circle profile'>
